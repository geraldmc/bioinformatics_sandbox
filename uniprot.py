...
class UniProt(object):
    ...
    def make_request_xml(self):
        ...
        #print (self.url)
        try:
            with closing(get(self.url, stream=True)) as response: #returns b`xml`
                if self.is_good_enough_xml(response):
    ...
    def make_request_txt(self):
        ...
        #print (self.url)
        try:
            with closing(get(self.url, stream=True)) as response: #returns b`txt`
                if self.is_txt(response):
